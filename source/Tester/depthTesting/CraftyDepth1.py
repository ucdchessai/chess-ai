...
nn_depth = 1 # <--- DEPTH OF OUR ALPHABETA ALGORITHM
engine_depth = 1 # <--- DEPTH OF THE ENGINE
...
def chooseEngine(num):
    ...
    return chess.engine.SimpleEngine.popen_uci("./stockfish_10_x32.exe")
...
res_file = open("CraftyDepth1.txt","a+")
print('-------------------------')
res_file.write("-------------------------\n")
